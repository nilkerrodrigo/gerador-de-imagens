...
export default function App() {
  ...
  useEffect(() => {
    ...
    // Load Gallery via Data Service (Supports Supabase or Local Fallback)
  ...
  // This prevents infinite loops or double saves when data comes from Supabase
  ...
  const handleGenerateCaption = async (creative: GeneratedCreative) => {
     ...
     try {
         ...
         // Atualiza persistência (Supabase ou Local)
         if (currentUser) {
